...
public class ListAdapterInformatika extends ArrayAdapter<InformatikaPitanje> implements View.OnClickListener  {

    List<InformatikaPitanje> items;
    Button nastavi;
    int start, end;
    ...
    public ListAdapterInformatika(Context context, int textViewResourceId) {
        super(context, textViewResourceId);
    }

    public ListAdapterInformatika(final Context context, int resource, List<InformatikaPitanje> items, int start, int end, String table_name, String godina, Activity a) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final InformatikaPitanje p = items.get(position);
...
//                                + p.getPitanje_id() + ", " + p.getGodina() + "," + p.getRok() + "," + p.getRazina(), Toast.LENGTH_LONG).show();
                ...
                if (p.getSlika() != null) {
                    ...
                    slika.setImageUrl("http://drzavnamatura.000webhostapp.com/images/informatika/" + p.getSlika() + ".png");
                }
    ...
    @Nullable
    @Override
    public InformatikaPitanje getItem(int position) {
        return items.get(position);
    }

    @Override
    public int getPosition(InformatikaPitanje item) {
    ...
    private void setupABCD(final InformatikaPitanje p, View v, final int position) {
