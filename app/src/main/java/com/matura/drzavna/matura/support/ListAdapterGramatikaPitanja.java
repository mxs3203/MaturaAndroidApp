...
public class ListAdapterGramatikaPitanja extends ArrayAdapter<GramatikaPitanje> implements View.OnClickListener{
    List<GramatikaPitanje> items;
    ...
    public ListAdapterGramatikaPitanja(Context context, int textViewResourceId) {
        super(context, textViewResourceId);
    }

    public ListAdapterGramatikaPitanja(Context context, int resource, List<GramatikaPitanje> items, int start, int end, String table_name, String godina, Activity a) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View v = convertView;
        int vrsta_pitanja = 0;
        final GramatikaPitanje p = items.get(position);
    ...
    @Nullable
    @Override
    public GramatikaPitanje getItem(int position) {
        return items.get(position);
    }

    @Override
    public int getPosition(GramatikaPitanje item) {
    ...
    public void setupABCD(final GramatikaPitanje p, View v, final int position) {
