...
public class ListAdapterPsihologija extends ArrayAdapter<PsihologijaPitanje> implements View.OnClickListener {


    List<PsihologijaPitanje> items;
    ...
    public ListAdapterPsihologija(Context context, int textViewResourceId) {
        super(context, textViewResourceId);
    }

    public ListAdapterPsihologija(Context context, int resource, List<PsihologijaPitanje> items, int start, int end, String table_name, String godina, Activity a) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View v = convertView;
        int vrsta_pitanja = 0;
        final PsihologijaPitanje p = items.get(position);
...
//                            + p.getPitanje_id() + ", " +p.getGodina() +","+ p.getRok() + ","+p.getRazina(), Toast.LENGTH_LONG).show();
    ...
    @Nullable
    @Override
    public PsihologijaPitanje getItem(int position) {
        return items.get(position);
    }

    @Override
    public int getPosition(PsihologijaPitanje item) {
    ...
    public void setupABCD(final PsihologijaPitanje p, View v, final int position)
    {
